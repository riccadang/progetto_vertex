...
#         covering_vector = masked_service.get_masked_vectors_that_covers_vector(eight_vector[0], dict)
#
...
#         print("eccoci")
#         key = masked_service.get_max_masked_vectors_that_covers_vector(vector[1], dict)
